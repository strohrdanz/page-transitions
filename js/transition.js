...
var PageTransitions = (function () {
	...
	function init() {
		...
		$('.pt-page').each( function(){
			...
			$('.filmstrip').append('<div class="thumb thumb' + picNumber + ' pt-trigger" data-goto="' + picNumber + '"" data-animation="' + nextAnimationNumber + '"><img src="img/' + picNumber + 'thumb.jpg"></div>');
		});
...
$(document).ready(function() {
	...
	// IE reset - some of the fancier animations don't work well on IE, so we change it to a basic fade/slide
	var doc = document.documentElement;
	doc.setAttribute('data-useragent', navigator.userAgent);

	var browser = $('html').attr('data-useragent');

	if(browser.match(/MSIE 10.0/g) || browser.match(/rv:11.0/g)) {
		$('.next').attr('data-animation',"7");
		$('.prev').attr('data-animation',"8");
	}
	...
	$(document).keydown(function(e) {
		...
		$('.pt-wrapper').swipeup(function(){
			$('.next').trigger('click');
		});
		$('.pt-wrapper').swipedown(function(){
			$('.prev').trigger('click');
		});
